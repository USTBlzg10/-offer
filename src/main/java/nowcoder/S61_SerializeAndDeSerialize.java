 ...
 */
public class S61_SerializeAndDeSerialize {
    public int index = -1;
    ...
    public static void main(String[] args){
        S61_SerializeAndDeSerialize s61 = new S61_SerializeAndDeSerialize();
        PrintTreeLayer p = new PrintTreeLayer();
        Integer[] array = {8,6,10,5,7,9,11};
        TreeNode root = p.arrayToTree(array, 0);
        System.out.println(s61.Serialize(root));
    }
}
